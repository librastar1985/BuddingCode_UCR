...
void System::solveSystem() {
	...
	generalParams.volume_spring_constant = 1.825;//0.75;
	...
	double scale_linear = 24.0;
	double scale_bend = 0.5*75.0;
	double scale_area = 1.25*75.0;
	...
	int NKBT = 20000; //The max number of edge-swap attempt per kBT value
