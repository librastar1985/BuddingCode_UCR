...
#$ -N  "withseptin_postswapremesh_1triexp_lw15d0bw7d5aw5d0_tau0d5_volsp7d0_ss0d1_dt0d00002_" # Specify job name
...
./virus-model  -solve_time=100 -dt=0.00005 $data[${SGE_TASK_ID}]
